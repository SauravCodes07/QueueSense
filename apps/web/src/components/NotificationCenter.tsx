  ...
  return (
    ...
    >
      <div className="absolute inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
        <div
          className="w-screen max-w-full sm:max-w-sm clinical-card border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl flex flex-col rounded-none"
        ...
        >
          ...
          <div className="px-4 py-2 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs">
            ...
            <button
              ...
              className="text-slate-500 hover:text-rose-600 dark:text-slate-400 flex items-center space-x-1"
            >
          ...
          {/* Footer status note */}
          <div className="p-3 border-t border-slate-200 dark:border-slate-800 text-[11px] text-slate-400 text-center flex items-center justify-center space-x-1.5 bg-slate-50 dark:bg-slate-800/30">
            <Radio className="w-3 h-3 text-emerald-600 animate-pulse flex-shrink-0" />
            <span>Connected to Live Fastify SSE Stream</span>
          </div>
        </div>
      </div>
    </div>
