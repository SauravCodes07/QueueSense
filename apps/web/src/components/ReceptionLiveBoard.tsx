                    ...
                    >
                      ...
                      <div className="flex items-center space-x-1.5 flex-shrink-0">
                        ...
                        <button
                          ...
                          className="p-1 rounded-lg bg-slate-100 dark:bg-slate-700 hover:text-teal-600 text-slate-500 transition-colors cursor-pointer"
                        >
                          <ArrowRightLeft className="w-3.5 h-3.5" />
                        </button>
                        <button
                          onClick={() => {
                            callPatient(p.id, doc.id);
                            addNotification('Patient Called', `Called ${p.token} (${p.name}) to ${doc.room}`, 'info');
                          }}
                          className="px-2.5 py-1 rounded-lg bg-teal-600 hover:bg-teal-500 text-white text-[10px] font-semibold transition-colors shadow-sm cursor-pointer"
                        >
                          {t('doctor.call_btn')}
                        </button>
                      </div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <button onClick={() => setTransferSourcePatient(null)} className="p-1 text-slate-400 hover:text-slate-600 cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleExecuteTransfer} className="space-y-3.5 text-xs">
              ...
              <div className="pt-2 flex justify-end space-x-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-semibold shadow-sm cursor-pointer"
                >
